...
function createEmptyBookingModelStub(): BookingModel {
...
describe('BookingService', () => {
  it('prevents overbooking under concurrent requests', async () => {
    const gymModel = createGymModelStub([
      {
        id: 'gym-1',
        name: 'Peak Club',
        capacityLimit: 1,
    ...
    const bookingModel = createEmptyBookingModelStub();
